...
local config = {
    ...
    plugins = {
        ...
        -- },
        -- Color Schemes
        {"folke/tokyonight.nvim"}, {"catppuccin/nvim"}, {"morhetz/gruvbox"}, {
            "catppuccin/nvim",
            as = "catppuccin"
        }, {
            "projekt0n/github-nvim-theme",
            as = "github"
        }, {"joshdick/onedark.vim"}, -- Utilities
        {"tpope/vim-surround"}, {
        ...
        ["null-ls"] = function(config)
            ...
            null_ls.builtins.diagnostics.rubocop, null_ls.builtins.code_actions.eslint,
